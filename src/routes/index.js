...
import { Login, SignUp, ListBoard, Test, ForgotPassword } from "../Pages";
...
const privateRoutes = [{ path: config.routes.listboard, component: ListBoard }, ...UserRoutes, ...DashboardsRoutes];
